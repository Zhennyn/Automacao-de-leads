...
const mockLeads = [
  {
    ...
    ai_summary: "Lead altamente qualificado. Agência de marketing com orçamento de R$15k, busca automação de atendimento. Interesse imediato, respondeu em menos de 5 minutos.",
  },
  {
    name: "Mariana Costa",
    ...
    ai_summary: "Lead média qualificação. Infoprodutora com orçamento de R$5k, perda de leads no funil. Precisa de acompanhamento para converter.",
  },
  {
    ...
    ai_summary: "Lead convertido. Loja virtual com orçamento de R$22k, foco em recuperação de carrinhos. Assinou plano Enterprise.",
  },
  {
    name: "Juliana Santos",
    ...
    ai_summary: "Lead baixa qualificação. Consultoria de RH, orçamento limitado. Talvez não seja um fit agora.",
  },
];
